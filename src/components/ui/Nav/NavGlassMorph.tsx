    ...
    <>
      ...
      >
        <GlassSurface
          ...
          height="auto"
          borderRadius={16}
          borderWidth={isMobile ? 0.3 : 0.15}
          brightness={isMobile ? 30 : 15}
          opacity={isMobile ? 0.95 : 0.85}
          blur={isMobile ? 4 : 8}
          backgroundOpacity={isMobile ? 0.6 : 0.2}
          saturation={isMobile ? 2.0 : 1.5}
          distortionScale={isMobile ? -120 : -180}
          redOffset={isMobile ? 5 : 0}
          greenOffset={isMobile ? 15 : 10}
          blueOffset={isMobile ? 25 : 20}
          mixBlendMode={isMobile ? "overlay" : "difference"}
          className={cn(
          ...
          style={
            isMobile
              ? {
                  // Force stronger mobile styles to override fallbacks
                  background: "rgba(0, 0, 0, 0.8) !important",
                  border: "2px solid rgba(255, 255, 255, 0.5) !important",
                  boxShadow:
                    "0 12px 40px rgba(0, 0, 0, 0.5), inset 0 2px 0 rgba(255, 255, 255, 0.5), inset 0 -2px 0 rgba(255, 255, 255, 0.3) !important",
                  // Enhanced backdrop for mobile
                  backdropFilter: "blur(20px) saturate(200%) contrast(120%) !important",
                  WebkitBackdropFilter: "blur(20px) saturate(200%) contrast(120%) !important",
                }
              : {
                  // Ensure desktop gets the full effect
